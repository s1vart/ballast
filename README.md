...
2. Under **Link → API / allowed** settings, add your **Android package name** (use `io.github.s1vart.ballast`, or whatever you set in `app/app.json`). This must match, or Android Link fails.
